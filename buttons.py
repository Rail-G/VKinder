...
class Button:
    ...
    def delete_black_list(self) -> VkKeyboard:
        ...
        delete_black_list.add_button('Назад в меню.', color=VkKeyboardColor.PRIMARY)
    ...
    def delete_photo(self):
        ...
        delete_photo.add_button('Назад в меню.', color=VkKeyboardColor.PRIMARY)
    ...
    def delete_favorite(self):
        ...
        delete_favorite.add_button('Назад в меню.', color=VkKeyboardColor.PRIMARY)
