...
class Button:
    ...
    def next(self) -> VkKeyboard:
        ...
        next_key.add_button('Показать чёрный список', color=VkKeyboardColor.SECONDARY)
        next_key.add_line()
    ...
    def delete_black_list(self) -> VkKeyboard:
        ...
        delete_black_list.add_button('Назад', color=VkKeyboardColor.NEGATIVE)
    ...
    def yes_or_no(self) -> VkKeyboard:
        ...
        yes_or_no.add_button('Нет, я передумал', color=VkKeyboardColor.SECONDARY)
